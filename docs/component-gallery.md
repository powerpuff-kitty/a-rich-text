...
cells. Column edits also account for rowspans, widening crossing cells on
insertion and shrinking or removing them on deletion. Select Build to merge right into Deliver even though
